...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src\\components\\alterPassword.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-6e90f0ec/alterPassword.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./alterPassword.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./alterPassword.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        personalAlterPwd: function personalAlterPwd() {
	            var _this = this;
	            ...
	            if (this.oldpwd != '' && this.newPwdValue != '') {
	                if (this.newPwdValue == this.repeatPwdValue) {
	                    $.ajax({
	                        url: _store2.default.state.hostUrl + 'modifypwd',
	                        data: {
	                            loginType: 1,
	                            sign: sign_token,
	                            oldpwd: oldHash,
	    ...
	    vuex: {
	        ...
	        getters: {
	            ache_userLogoutState: _getters.getLoginState
	        }
	    }
	};
	// </script>
