...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\vue\\discountList.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0a520f14/discountList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./discountList.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./discountList.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".discount-list {\n  background: #f8f8f8; }\n  .discount-list .discount-header {\n    width: 100%;\n    height: 0.9rem;\n    font-size: 0.34rem;\n    color: #404040;\n    text-align: center;\n    box-sizing: border-box;\n    line-height: 0.9rem;\n    border-bottom: 1px solid #e6e6e6;\n    background: #fff;\n    position: fixed;\n    top: 0;\n    z-index: 99; }\n    .discount-list .discount-header .goback-Btn {\n      position: absolute;\n      width: 0.9rem;\n      height: 0.9rem;\n      left: 0;\n      top: 0;\n      background: url(" + __webpack_require__(76) + ") no-repeat center center;\n      background-size: 80% 80%; }\n  .discount-list .discount-box {\n    width: 100%;\n    overflow: hidden;\n    margin-top: 0.9rem; }\n    .discount-list .discount-box .discount-content {\n      padding: 0 0.25rem;\n      box-sizing: border-box;\n      width: 100%;\n      margin-top: 0.2rem;\n      background: #fff; }\n      .discount-list .discount-box .discount-content a {\n        display: block;\n        box-sizing: border-box;\n        width: 100%;\n        height: 2.8rem; }\n        .discount-list .discount-box .discount-content a img {\n          width: 100%;\n          height: 100%; }\n      .discount-list .discount-box .discount-content .discount-describe {\n        width: 100%;\n        height: 0.9rem;\n        font-size: 0.28rem;\n        color: #404040;\n        line-height: 0.9rem;\n        white-space: nowrap;\n        overflow: hidden;\n        text-overflow: ellipsis; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		methods: {
			getDiscountListData: function getDiscountListData() {
				var _this2 = this;

				$.ajax({
					type: "post",
					contentType: "application/x-www-form-urlencoded; charset=UTF-8",
					url: _store2.default.state.hostUrl + "discountlist",
					cache: false,
					data: {
						pageNo: this.pageNo
					},
					...
					success: function success(res) {
						...
						if (res.data) {
							if (res.data.list) {
								_this2.discountLists = _this2.discountLists.concat(res.data.list);
								_this2.pageNo++;
							};
							_this2.scroll = true;
			...
			scrollDislist: function scrollDislist() {
				if (this.scroll) {
