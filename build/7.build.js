...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\vue\\quesAndAnsList.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-4ff3bb94/quesAndAnsList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./quesAndAnsList.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./quesAndAnsList.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@-webkit-keyframes carousel {\n  0% {\n    opacity: 1;\n    z-index: 2; }\n  99% {\n    opacity: 0;\n    z-index: 2;\n    top: -0.6rem; }\n  100% {\n    opacity: 0;\n    z-index: -1;\n    top: 0; } }\n\n@keyframes carousel {\n  0% {\n    opacity: 1;\n    z-index: 2; }\n  99% {\n    opacity: 0;\n    z-index: 2;\n    top: -0.6rem; }\n  100% {\n    opacity: 0;\n    z-index: -1;\n    top: 0; } }\n\n.question-answer-list {\n  background: #f8f8f8; }\n  .question-answer-list .question-answer-header {\n    width: 100%;\n    height: 0.9rem;\n    font-size: 0.34rem;\n    color: #404040;\n    text-align: center;\n    box-sizing: border-box;\n    line-height: 0.9rem;\n    border-bottom: 1px solid #e6e6e6;\n    background: #fff;\n    position: fixed;\n    top: 0;\n    z-index: 99; }\n    .question-answer-list .question-answer-header .goback-Btn {\n      position: absolute;\n      width: 0.9rem;\n      height: 0.9rem;\n      left: 0;\n      top: 0;\n      background: url(" + __webpack_require__(76) + ") no-repeat center center;\n      background-size: 80% 80%; }\n    .question-answer-list .question-answer-header .my-question {\n      height: 0.9rem;\n      position: absolute;\n      font-size: 0.28rem;\n      line-height: 0.9rem;\n      color: #404040;\n      right: 0.4rem;\n      top: 0; }\n  .question-answer-list .question-answer-list-box {\n    margin-top: 0.9rem; }\n    .question-answer-list .question-answer-list-box .questions-and-answers-list {\n      width: 100%;\n      box-sizing: border-box;\n      padding: 0 0.25rem;\n      border-top: 2px solid #f2f2f2;\n      background: #fff; }\n      .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers {\n        width: 100%; }\n        .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .question-information {\n          width: 100%;\n          padding-top: 0.25rem; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .question-information div {\n            font-size: 0.24rem;\n            color: #ababab; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .question-information .questioner-name {\n            float: left; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .question-information .question-date {\n            float: right;\n            margin-right: 0.25rem; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .question-information .question-watch {\n            float: right; }\n        .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .question {\n          width: 100%;\n          padding: 0.2rem 0rem;\n          font-size: 0.28rem;\n          min-height: 0.45rem;\n          line-height: 0.45rem;\n          color: #404040;\n          border-bottom: 1px solid #f2f2f2; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .question i {\n            display: block;\n            float: left;\n            width: 0.42rem;\n            height: 0.42rem;\n            background: #9dd2fe;\n            font-size: 0.26rem;\n            text-align: center;\n            color: #fff;\n            margin-right: 0.1rem;\n            background: url(" + __webpack_require__(23) + ") no-repeat;\n            background-size: 100% 100%; }\n        .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer {\n          width: 100%;\n          margin: 0.2rem 0rem;\n          font-size: 0.28rem;\n          height: 0.9rem;\n          line-height: 0.45rem;\n          color: #7c7c7c;\n          display: -webkit-box;\n          -webkit-box-orient: vertical;\n          -webkit-line-clamp: 2;\n          overflow: hidden; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer img {\n            width: 0.42rem;\n            height: 0.42rem;\n            margin-right: 0.1rem; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer i {\n            display: block;\n            float: left;\n            width: 0.42rem;\n            height: 0.42rem;\n            background: #d0beb2;\n            font-size: 0.26rem;\n            text-align: center;\n            color: #fff;\n            background: url(" + __webpack_require__(24) + ") no-repeat;\n            background-size: 100% 100%;\n            margin-right: 0.1rem; }\n        .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information {\n          width: 100%;\n          height: 0.5rem; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information div {\n            font-size: 0.24rem;\n            color: #ababab;\n            line-height: 0.26rem;\n            height: 0.26rem; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .answer-name {\n            float: left;\n            margin-right: 0.1rem; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .answer-occupation {\n            float: left; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .demote {\n            float: right;\n            padding-left: 0.4rem;\n            width: auto;\n            box-sizing: border-box;\n            height: 0.5rem;\n            background: url(" + __webpack_require__(25) + ") no-repeat 0rem 0rem;\n            background-size: 0.3rem 0.26rem;\n            position: relative; }\n            .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .demote i {\n              display: block;\n              position: absolute;\n              width: 0.3rem;\n              height: 0.26rem;\n              left: 0;\n              top: 0;\n              background: url(" + __webpack_require__(26) + ") no-repeat;\n              background-size: 100% 100%;\n              z-index: -1; }\n            .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .demote i.active {\n              z-index: 2; }\n          .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .fabulous {\n            float: right;\n            width: auto;\n            box-sizing: border-box;\n            height: 0.5rem;\n            padding-left: 0.4rem;\n            margin-right: 0.2rem;\n            background: url(" + __webpack_require__(27) + ") no-repeat 0rem 0rem;\n            background-size: 0.3rem 0.26rem;\n            position: relative; }\n            .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .fabulous i {\n              display: block;\n              position: absolute;\n              width: 0.3rem;\n              height: 0.26rem;\n              left: 0;\n              top: 0;\n              background: url(" + __webpack_require__(28) + ") no-repeat;\n              background-size: 100% 100%;\n              z-index: -1; }\n            .question-answer-list .question-answer-list-box .questions-and-answers-list .questions-and-answers .answer-information .fabulous i.active {\n              z-index: 2; }\n  .question-answer-list .go-ask-btn {\n    width: 1rem;\n    height: 1rem;\n    background: url(" + __webpack_require__(133) + ") no-repeat;\n    background-size: 100% 100%;\n    position: fixed;\n    right: 0.6rem;\n    bottom: 2rem;\n    z-index: 99; }\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		ready: function ready() {
			...
			$(".question-answer-list-box").on("click", ".demote", function (e) {
				var dom = e.target;
			...
			$(window).on('scroll', function () {
				_this.scrollQuesAnslist();
			});
		},
		methods: {
			getQueAnsListData: function getQueAnsListData(token) {
				var _this2 = this;
				...
				$.ajax({
					...
					success: function success(res) {
						...
						if (res.data) {
							if (res.data.list) {
								_this2.queAndAnsLists = _this2.queAndAnsLists.concat(res.data.list);
								_this2.pageNo++;
							};
							_this2.scroll = true;
