...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\vue\\QuesAndAnsDetail.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-1926e667/QuesAndAnsDetail.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./QuesAndAnsDetail.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./QuesAndAnsDetail.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@-webkit-keyframes carousel {\n  0% {\n    opacity: 1;\n    z-index: 2; }\n  99% {\n    opacity: 0;\n    z-index: 2;\n    top: -0.6rem; }\n  100% {\n    opacity: 0;\n    z-index: -1;\n    top: 0; } }\n\n@keyframes carousel {\n  0% {\n    opacity: 1;\n    z-index: 2; }\n  99% {\n    opacity: 0;\n    z-index: 2;\n    top: -0.6rem; }\n  100% {\n    opacity: 0;\n    z-index: -1;\n    top: 0; } }\n\n.question-and-answer-detail .ask-detail-header {\n  width: 100%;\n  height: 0.9rem;\n  font-size: 0.34rem;\n  color: #404040;\n  text-align: center;\n  box-sizing: border-box;\n  line-height: 0.9rem;\n  border-bottom: 1px solid #e6e6e6;\n  background: #fff; }\n  .question-and-answer-detail .ask-detail-header .goback-Btn {\n    position: absolute;\n    width: 0.9rem;\n    height: 0.9rem;\n    left: 0;\n    top: 0;\n    background: url(" + __webpack_require__(76) + ") no-repeat center center;\n    background-size: 80% 80%; }\n\n.question-and-answer-detail .questions-and-answers-list {\n  width: 100%;\n  box-sizing: border-box;\n  padding: 0 0.25rem;\n  border-top: 2px solid #f2f2f2;\n  background: #fff; }\n  .question-and-answer-detail .questions-and-answers-list .questions-and-answers {\n    width: 100%; }\n    .question-and-answer-detail .questions-and-answers-list .questions-and-answers .question-information {\n      width: 100%;\n      padding-top: 0.25rem; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .question-information div {\n        font-size: 0.24rem;\n        color: #ababab; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .question-information .questioner-name {\n        float: left; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .question-information .question-date {\n        float: right;\n        margin-right: 0.25rem; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .question-information .question-watch {\n        float: right; }\n    .question-and-answer-detail .questions-and-answers-list .questions-and-answers .question {\n      width: 100%;\n      padding: 0.2rem 0rem;\n      font-size: 0.28rem;\n      min-height: 0.45rem;\n      line-height: 0.45rem;\n      color: #404040;\n      border-bottom: 1px solid #f2f2f2; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .question i {\n        display: block;\n        float: left;\n        width: 0.42rem;\n        height: 0.42rem;\n        background: #9dd2fe;\n        font-size: 0.26rem;\n        text-align: center;\n        color: #fff;\n        margin-right: 0.1rem;\n        background: url(" + __webpack_require__(23) + ") no-repeat;\n        background-size: 100% 100%; }\n    .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer {\n      width: 100%;\n      margin: 0.2rem 0rem;\n      font-size: 0.28rem;\n      min-height: 0.9rem;\n      line-height: 0.45rem;\n      color: #7c7c7c; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer img {\n        width: 0.42rem;\n        height: 0.42rem;\n        margin-right: 0.1rem; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer i {\n        display: block;\n        float: left;\n        width: 0.42rem;\n        height: 0.42rem;\n        background: #d0beb2;\n        font-size: 0.26rem;\n        text-align: center;\n        color: #fff;\n        background: url(" + __webpack_require__(24) + ") no-repeat;\n        background-size: 100% 100%;\n        margin-right: 0.1rem; }\n    .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information {\n      width: 100%;\n      height: 0.3rem;\n      padding-bottom: 0.2rem; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information div {\n        font-size: 0.24rem;\n        color: #ababab;\n        line-height: 0.26rem;\n        height: 0.26rem; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .answer-name {\n        float: left;\n        margin-right: 0.1rem; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .answer-occupation {\n        float: left; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .demote {\n        float: right;\n        padding-left: 0.4rem;\n        background: url(" + __webpack_require__(25) + ") no-repeat left center;\n        background-size: 0.3rem 0.26rem;\n        position: relative; }\n        .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .demote i {\n          display: block;\n          position: absolute;\n          width: 0.3rem;\n          height: 0.26rem;\n          left: 0;\n          top: 0;\n          background: url(" + __webpack_require__(26) + ") no-repeat;\n          background-size: 100% 100%;\n          z-index: -1; }\n        .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .demote i.active {\n          z-index: 2; }\n      .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .fabulous {\n        float: right;\n        padding-left: 0.4rem;\n        margin-right: 0.2rem;\n        background: url(" + __webpack_require__(27) + ") no-repeat left center;\n        background-size: 0.3rem 0.26rem;\n        position: relative; }\n        .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .fabulous i {\n          display: block;\n          position: absolute;\n          width: 0.3rem;\n          height: 0.26rem;\n          left: 0;\n          top: 0;\n          background: url(" + __webpack_require__(28) + ") no-repeat;\n          background-size: 100% 100%;\n          z-index: -1; }\n        .question-and-answer-detail .questions-and-answers-list .questions-and-answers .answer-information .fabulous i.active {\n          z-index: 2; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		methods: {
			getQueDetail: function getQueDetail(id, token) {
				var _this2 = this;
				...
				console.log(_store2.default.state.hostUrl + "questiondetail?sign=" + token + "&loginType=1&qstId=" + id);
				$.ajax({
					type: "post",
					contentType: "application/x-www-form-urlencoded; charset=UTF-8",
					url: _store2.default.state.hostUrl + "questiondetail",
					cache: false,
					data: obj,
					...
					success: function success(res) {
						...
						if (res.data) {
							dataArr[0] = res.data;
							_this2.queAndAnsLists = _this2.queAndAnsLists.concat(dataArr);
						}
					}
				});
			},
