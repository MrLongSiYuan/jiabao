...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\vue\\insuranceStrategy.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0184cc28/insuranceStrategy.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./insuranceStrategy.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./insuranceStrategy.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".insurance-strategy {\n  background: #f8f8f8;\n  width: 100%; }\n  .insurance-strategy .Ins-header-box {\n    position: fixed;\n    width: 100%;\n    top: 0;\n    background: #fff;\n    z-index: 99; }\n    .insurance-strategy .Ins-header-box .ins-header {\n      width: 100%;\n      height: 0.9rem;\n      font-size: 0.34rem;\n      color: #404040;\n      text-align: center;\n      box-sizing: border-box;\n      line-height: 0.9rem;\n      border-bottom: 1px solid #e6e6e6;\n      background: #fff; }\n      .insurance-strategy .Ins-header-box .ins-header .goback-Btn {\n        position: absolute;\n        width: 0.9rem;\n        height: 0.9rem;\n        left: 0;\n        top: 0;\n        background: url(" + __webpack_require__(76) + ") no-repeat center center;\n        background-size: 80% 80%; }\n    .insurance-strategy .Ins-header-box .ins-tap-box {\n      width: 100%;\n      height: 0.9rem;\n      border-bottom: solid 1px #f3f3f3;\n      padding: 0 0.25rem;\n      box-sizing: border-box;\n      background: #fff;\n      position: absolute;\n      top: 0.9rem; }\n      .insurance-strategy .Ins-header-box .ins-tap-box .ins-tap {\n        display: block;\n        box-sizing: border-box;\n        height: 100%;\n        width: 100%;\n        position: relative; }\n        .insurance-strategy .Ins-header-box .ins-tap-box .ins-tap li {\n          width: 25%;\n          float: left;\n          height: 100%;\n          display: block;\n          font-size: 0.28rem;\n          text-align: center;\n          line-height: 0.9rem;\n          box-sizing: border-box; }\n        .insurance-strategy .Ins-header-box .ins-tap-box .ins-tap li.active {\n          color: #0e94f7; }\n        .insurance-strategy .Ins-header-box .ins-tap-box .ins-tap .tap-footer-bar {\n          width: 25%;\n          border-bottom: 3px solid #0e94f7;\n          position: absolute;\n          left: 0;\n          bottom: 0;\n          -webkit-transition: left 0.5s;\n          transition: left 0.5s; }\n  .insurance-strategy .Ins-content-box {\n    width: 100%;\n    height: 10.22rem;\n    margin-top: 1.8rem; }\n    .insurance-strategy .Ins-content-box .swiper-container {\n      width: 100%;\n      height: 100%; }\n      .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll {\n        width: 100%;\n        height: 100%;\n        overflow: hidden; }\n        .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list {\n          width: 100%;\n          height: 2.12rem;\n          box-sizing: border-box;\n          background: #fff;\n          padding: 0.3rem 0.3rem 0; }\n          .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list a {\n            display: block;\n            width: 100%;\n            height: 100%;\n            border-bottom: 1px solid #f3f3f3;\n            box-sizing: border-box; }\n          .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list .strategy-list-img {\n            width: 2rem;\n            height: 1.5rem;\n            float: left; }\n            .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list .strategy-list-img img {\n              width: 100%;\n              height: 100%; }\n          .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list .strategy-list-describe {\n            width: 4.52rem;\n            height: 0.98rem;\n            margin-left: 0.35rem;\n            font-size: 0.28rem;\n            color: #424242;\n            line-height: 0.48rem;\n            float: left;\n            overflow: hidden;\n            display: -webkit-box;\n            -webkit-line-clamp: 2;\n            -webkit-box-orient: vertical;\n            text-overflow: ellipsis; }\n          .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list .strategy-list-infor {\n            font-size: 0.24rem;\n            color: #909090;\n            float: left;\n            width: 4.52rem;\n            height: 0.6rem;\n            margin-left: 0.35rem; }\n            .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list .strategy-list-infor .list-infor-date {\n              height: 100%;\n              line-height: 0.6rem;\n              float: left; }\n            .insurance-strategy .Ins-content-box .swiper-container .swiper-wrapper .swiper-slide .ins-scroll .Ins-content .strategy-list .strategy-list-infor .list-infor-watch {\n              height: 100%;\n              line-height: 0.6rem;\n              float: right;\n              box-sizing: border-box;\n              padding-left: 0.4rem;\n              background: url(" + __webpack_require__(122) + ") no-repeat left;\n              background-size: 0.32rem 0.2rem; }\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IScroll = __webpack_require__(71);
	var myScroll1;
	var myScroll2;
	var myScroll3;
	var myScroll4;
	exports.default = {
		...
		watch: {
			strategyList1: function strategyList1() {
				myScroll1.refresh();
			},
			strategyList2: function strategyList2() {
				myScroll2.refresh();
			},
			strategyList3: function strategyList3() {
				myScroll3.refresh();
			},
			strategyList4: function strategyList4() {
				myScroll4.refresh();
			}
		},
		ready: function ready() {
			...
			var mySwiper = new Swiper('.swiper-container', {
				...
				onTransitionStart: function onTransitionStart(swiper) {
					var linum = mySwiper.activeIndex + 1;
			...
			myScroll1.on("scrollEnd", function () {
				var totalheight = Math.ceil($('#wrapper1 .Ins-content').height() - $("#wrapper1").height());
				if (-myScroll1.y <= totalheight && !_this.noMoreData[0]) {
					_this.getStrategyData(1, pageNoArr[0]);
					_this.loaddata1.showRefresh = false;
					_this.loaddata1.showLoad = true;
					_this.loaddata1.showNoData = false;
				};
			});
			myScroll2.on("scrollEnd", function () {
				var totalheight = Math.ceil($('#wrapper2 .Ins-content').height() - $("#wrapper2").height());
				if (-myScroll2.y <= totalheight && !_this.noMoreData[1]) {
					_this.getStrategyData(2, pageNoArr[1]);
					_this.loaddata2.showRefresh = false;
					_this.loaddata2.showLoad = true;
					_this.loaddata2.showNoData = false;
				};
			});
			myScroll3.on("scrollEnd", function () {
				var totalheight = Math.ceil($('#wrapper2 .Ins-content').height() - $("#wrapper2").height());
				if (-myScroll3.y <= totalheight && !_this.noMoreData[2]) {
					_this.getStrategyData(3, pageNoArr[2]);
					_this.loaddata3.showRefresh = false;
					_this.loaddata3.showLoad = true;
					_this.loaddata3.showNoData = false;
				};
			});
			myScroll4.on("scrollEnd", function () {
				var totalheight = Math.ceil($('#wrapper2 .Ins-content').height() - $("#wrapper2").height());
				if (-myScroll4.y <= totalheight && !_this.noMoreData[3]) {
					_this.getStrategyData(4, pageNoArr[3]);
					_this.loaddata4.showRefresh = false;
					_this.loaddata4.showLoad = true;
					_this.loaddata4.showNoData = false;
				};
			});
		},
		methods: {
			setIscrollHeight: function setIscrollHeight() {
				var browser = {
					versions: function () {
			...
			getStrategyData: function getStrategyData(strategyType, pageNo) {
				var _this2 = this;

				$.ajax({
					type: "post",
					contentType: "application/x-www-form-urlencoded; charset=UTF-8",
					url: _store2.default.state.hostUrl + "strategylist",
					cache: false,
					data: {
					...
					success: function success(res) {
						...
						if (res.data) {
							if (strategyType == 1) {
								_this2.strategyList1 = _this2.strategyList1.concat(res.data.list);
								_this2.getDataPageNo[0] += 1;
								_this2.loaddata1.showRefresh = true;
								_this2.loaddata1.showLoad = false;
								_this2.loaddata1.showNoData = false;
								if (res.data.lastPage) {
									_this2.noMoreData[0] = true;
									_this2.loaddata1.showRefresh = false;
									_this2.loaddata1.showLoad = false;
									_this2.loaddata1.showNoData = true;
								};
							} else if (strategyType == 2) {
								_this2.strategyList2 = _this2.strategyList2.concat(res.data.list);
								_this2.getDataPageNo[1] += 1;
								_this2.loaddata2.showRefresh = true;
								_this2.loaddata2.showLoad = false;
								_this2.loaddata2.showNoData = false;
								if (res.data.lastPage) {
									_this2.noMoreData[1] = true;
									_this2.loaddata2.showRefresh = false;
									_this2.loaddata2.showLoad = false;
									_this2.loaddata2.showNoData = true;
								};
							} else if (strategyType == 3) {
								_this2.strategyList3 = _this2.strategyList3.concat(res.data.list);
								_this2.getDataPageNo[2] += 1;
								_this2.loaddata3.showRefresh = true;
								_this2.loaddata3.showLoad = false;
								_this2.loaddata3.showNoData = false;
								if (res.data.lastPage) {
									_this2.noMoreData[2] = true;
									_this2.loaddata3.showRefresh = false;
									_this2.loaddata3.showLoad = false;
									_this2.loaddata3.showNoData = true;
								};
							} else if (strategyType == 4) {
								_this2.strategyList4 = _this2.strategyList4.concat(res.data.list);
								_this2.getDataPageNo[3] += 1;
								_this2.loaddata4.showRefresh = true;
								_this2.loaddata4.showLoad = false;
								_this2.loaddata4.showNoData = false;
								if (res.data.lastPage) {
									_this2.noMoreData[3] = true;
									_this2.loaddata4.showRefresh = false;
									_this2.loaddata4.showLoad = false;
									_this2.loaddata4.showNoData = true;
								};
							}
						} else {
							if (strategyType == 1) {
